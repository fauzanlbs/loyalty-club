...
export default class Kantor extends Component{
    static navigationOptions = {
        headerTitle: <HeaderTitle text="Kantor PLN"/> ,
            ...
            let markers = this.state.data_kantor.map((data,index) => {
                ...
                return(
                          ...
                          <MapView.Marker
                            ...
                            longitude: data.lon}}
                            title={data.NamaKantor}
                            description={data.Alamat_Kantor}
                         />
                )
    ...
    async _refreshOffice(){
        ...
        client.get('/masterOffice').then((response) => {
